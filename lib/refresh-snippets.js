...
module.exports = refreshSnippets = {
  ...
  scheduleRefresh: function () {
    if(!this.refreshScheduled){
      ...
      setTimeout(function () {
        ...
        console.log("this.refreshScheduled = " + this.refreshScheduled)
      }, 10000)
      setTimeout(function () {
  ...
  watchNodeModules: function (projectsInWorkspace) {
    ...
    setTimeout(function(){
      console.log("waited 10 secsss")
      for(i=0; i<watchers.length; i++)
        console.log(watchers[i].getWatched())
    }, 10000)
  },
  refreshSnippets: function () {
    console.log("refreshSnippets")
    var snippetsArray = []
    for (var i = 0; i < this.projectsInWorkspace.length; i++) {
      try {
